    ...
    public partial class companiesProduct : Form
    {
        ...
        private void button3_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                features[anzahlFeatures] = comboBox1.SelectedItem.ToString();
        ...
        private void button1_Click_1(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show("Need added!");
                needs[anzNeeds] = comboBox3.SelectedItem.ToString();
                anzNeeds = anzNeeds + 1;
            }
        }
